...
dataset = "profile_report" # Enter the name or ID of the semantic model
workspace = "NASES DWH 2.0 - DEV" # Enter the workspace name or ID in which the semantic model exists
